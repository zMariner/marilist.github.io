window.addEventListener('DOMContentLoaded', function() {
  var levels = [
    ...
    { name: '#N/A - Shitty Minusdry', id: '90383862', author: 'Wiktor and Mystix', Beaten: '29 Apr 2023', videoUrl: 'https://www.youtube.com/watch?v=yd3RoTdunJo', type: 'Level' },
...
listItem.addEventListener('click', function() {
  ...
  var thumbnailLink = document.createElement('a');
  thumbnailLink.href = levels[index].videoUrl;
  thumbnailLink.target = '_blank';
  thumbnailLink.appendChild(thumbnailImage);
  ...
  // Append the thumbnail to the popup video
  popupVideo.appendChild(thumbnailLink);
